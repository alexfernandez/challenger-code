...
const {findChallenge, listChallenges} = require('./challenge/main.js')
const {findUserChallenge} = require('./challenge/db.js')
const {difficulties, categories} = require('./challenge/challenge.js')
const {findUser, loginWithGithub} = require('./user/index.js')
